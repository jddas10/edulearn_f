...
import 'teacher_recorded_screen.dart';
import 'teacher_live_lecture_screen.dart';
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _PendingCard(
                          ...
                          subtitle: '• Homework to Review: 12',
                          progress: 0.6,
                          accent: accent,
                        ),
                        ...
                        _PendingCard(
                          ...
                          subtitle: '• Attendance Not Taken: 1 class',
                          progress: 0.2,
                          accent: accent,
                        ),
                      ],
  ...
  Widget build(BuildContext context) {
    final actions = [
      ...
      _ActionItem(
        ...
        onTap: () => Navigator.push(
          context,
          MaterialPageRoute(builder: (_) => const TeacherRecordedScreen()),
        ),
      ),
      _ActionItem(
        label: 'Live Classes',
        ...
        onTap: () => Navigator.push(
          context,
          MaterialPageRoute(builder: (_) => const TeacherLiveLectureScreen()),
        ),
      ),
      _ActionItem(
        label: 'Quiz',
