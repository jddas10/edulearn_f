...
class TeacherLiveLectureScreen extends StatefulWidget {
  const TeacherLiveLectureScreen({super.key});

  @override
  State<TeacherLiveLectureScreen> createState() => _TeacherLiveLectureScreenState();
}

class _TeacherLiveLectureScreenState extends State<TeacherLiveLectureScreen>
...
class _LiveBgPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    _orb(
      canvas,
      Offset(size.width * 0.92, size.height * 0.10 - ease * 12),
      size.width * 0.70,
    ...
    _orb(
      canvas,
      Offset(-size.width * 0.10 + ease * 10, size.height * 0.52),
      size.width * 0.60,
    ...
    _orb(
      canvas,
      Offset(size.width * 0.88, size.height * 0.92 + ease * 10),
      size.width * 0.55,
